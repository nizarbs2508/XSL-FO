...
<xsl:template match="/">
      ...
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Vérification de conformité du document au modèle BIO-CR-BIO_2022.01"
                              schemaVersion="CI-SIS_BIO-CR-BIO_2022.01.sch">
         <xsl:attribute name="phase">CI-SIS_BIO-CR-BIO_2022.01</xsl:attribute>
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">JDV_HL7_ObservationInterpretation-CISIS</xsl:attribute>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Vérification de conformité du document au modèle BIO-CR-BIO_2022.01</svrl:text>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="cda:templateId[@root=&#34;1.3.6.1.4.1.19376.1.3.3&#34; and @extension=&#34;2022.01&#34;]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="             (count(./cda:entryRelationship/cda:act/cda:code[@code = 'SPRECEIVE']/../cda:effectiveTime[@value]/../../../cda:templateId[@root='1.3.6.1.4.1.19376.1.3.1.2'])             =              count((./cda:entryRelationship/cda:act/cda:code[@code = 'SPRECEIVE']/../../../cda:templateId[@root='1.3.6.1.4.1.19376.1.3.1.2'])))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
...
<xsl:choose>
   ...
   <!--PATTERN JDV_HL7_ObservationInterpretation-CISIS-->
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(             @nullFlavor or             (@xsi:type and not(@xsi:type = 'CD') and not(@xsi:type = 'CE')) or              (document($JDV_HL7_ObservationInterpretation-CISIS)//svs:Concept[@code=$att_code and @codeSystem=$att_codeSystem])             )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            ...
            doit faire partie du jeu de valeurs <xsl:text/>
                  <xsl:value-of select="$JDV_HL7_ObservationInterpretation-CISIS"/>
                  <xsl:text/>.
        </svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
   ...
   <!--PATTERN variables-->
<xsl:variable name="JDV_HL7_ObservationInterpretation-CISIS"
                 select="'../jeuxDeValeurs/JDV_HL7_ObservationInterpretation-CISIS.xml'"/>
